...
test("Phase 4.1 API exposes VAT masterdata, dated rule packs, explainable decisions and review queue", async () => {
  ...
  try {
    ...
    assert.equal(packs2025.items[0].rulePackId, "vat-se-2025.4");
    ...
    assert.equal(decision2025.vatDecision.rulePackId, "vat-se-2025.4");
    ...
    assert.equal(decision.vatDecision.rulePackId, "vat-se-2026.1");
