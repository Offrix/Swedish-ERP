...
import {
  ...
  CLOSE_ADJUSTMENT_STATUSES,
  CLOSE_ADJUSTMENT_TYPES,
  CLOSE_CHECKLIST_STATUSES,
  CLOSE_REOPEN_REQUEST_STATUSES,
  CLOSE_STEP_STATUSES,
  PERIOD_CLOSE_STATES,
  createCloseModule
} from "./close.mjs";
import {
  ...
  BREAK_GLASS_STATES,
  CALLBACK_SECRET_STATUSES,
  CERTIFICATE_CHAIN_STATUSES,
  IMPERSONATION_MODES,
  IMPERSONATION_STATES,
  MANAGED_SECRET_STATUSES,
  MANAGED_SECRET_TYPES,
  SECRET_ROTATION_RECORD_STATUSES,
...
import {
  ...
  ROLLBACK_CHECKPOINT_STATUSES,
  REPLAY_DRILL_STATUSES,
  RESTORE_DRILL_REQUIRED_TYPES,
  RESTORE_DRILL_TYPES,
...
export {
  COMMIT_LAG_STATES,
  PROJECTION_REBUILD_GATE_STATES,
  summarizeProjectionRebuildGates,
  summarizeTransactionBoundary
} from "./transaction-boundary.mjs";
import {
...
export function createCoreEngine({
  ...
  const state = {
    ...
    secretRotationRecords: new Map(),
    certificateChains: new Map(),
    callbackSecrets: new Map(),
    featureFlags: new Map(),
    emergencyDisables: new Map(),
    loadProfiles: new Map(),
    rollbackCheckpoints: new Map(),
    restoreDrills: new Map(),
    replayDrills: new Map(),
  ...
  const engine = {
    ...
    approvalPackageStatuses: APPROVAL_PACKAGE_STATUSES,
      ...
      restoreDrillRequiredTypes: RESTORE_DRILL_REQUIRED_TYPES,
      ...
      chaosScenarioRequiredCodes: CHAOS_SCENARIO_REQUIRED_CODES,
    ...
    resolveWorkItem,
      ...
      listCloseReopenRequests: closeModule.listCloseReopenRequests,
      getCloseReopenRequest: closeModule.getCloseReopenRequest,
      requestCloseReopen: closeModule.requestCloseReopen,
      listCloseAdjustments: closeModule.listCloseAdjustments,
      getCloseAdjustment: closeModule.getCloseAdjustment,
      createCloseAdjustment: closeModule.createCloseAdjustment,
      relockCloseReopenRequest: closeModule.relockCloseReopenRequest,
      ...
      registerReplayOperation: backofficeModule.registerReplayOperation,
      recordReplayOperationApproval: backofficeModule.recordReplayOperationApproval,
      recordReplayOperationExecution: backofficeModule.recordReplayOperationExecution,
      listReplayOperations: backofficeModule.listReplayOperations,
      registerManagedSecret: backofficeModule.registerManagedSecret,
      listManagedSecrets: backofficeModule.listManagedSecrets,
      rotateManagedSecret: backofficeModule.rotateManagedSecret,
      revokeManagedSecret: backofficeModule.revokeManagedSecret,
      listSecretRotationRecords: backofficeModule.listSecretRotationRecords,
      registerCertificateChain: backofficeModule.registerCertificateChain,
      listCertificateChains: backofficeModule.listCertificateChains,
      revokeCertificateChain: backofficeModule.revokeCertificateChain,
      registerCallbackSecret: backofficeModule.registerCallbackSecret,
      listCallbackSecrets: backofficeModule.listCallbackSecrets,
      revokeCallbackSecret: backofficeModule.revokeCallbackSecret,
      ...
      activateBreakGlass: backofficeModule.activateBreakGlass,
      ...
      createRollbackCheckpoint: publicResilienceModule.createRollbackCheckpoint,
      sealRollbackCheckpoint: publicResilienceModule.sealRollbackCheckpoint,
      useRollbackCheckpoint: publicResilienceModule.useRollbackCheckpoint,
      expireRollbackCheckpoint: publicResilienceModule.expireRollbackCheckpoint,
      listRollbackCheckpoints: publicResilienceModule.listRollbackCheckpoints,
      recordRestoreDrill: publicResilienceModule.recordRestoreDrill,
      startRestoreDrill: publicResilienceModule.startRestoreDrill,
      completeRestoreDrill: publicResilienceModule.completeRestoreDrill,
      listRestoreDrills: publicResilienceModule.listRestoreDrills,
      getRestoreDrillCoverageSummary: publicResilienceModule.getRestoreDrillCoverageSummary,
      recordReplayDrill: publicResilienceModule.recordReplayDrill,
      startReplayDrill: publicResilienceModule.startReplayDrill,
      completeReplayDrill: publicResilienceModule.completeReplayDrill,
      listReplayDrills: publicResilienceModule.listReplayDrills,
      getReplayDrillSummary: publicResilienceModule.getReplayDrillSummary,
      ...
      recordParallelRunResult: migrationModule.recordParallelRunResult,
      listParallelRunResults: migrationModule.listParallelRunResults,
      acceptParallelRunResult: migrationModule.acceptParallelRunResult,
      createCutoverPlan: migrationModule.createCutoverPlan,
      listCutoverPlans: migrationModule.listCutoverPlans,
      getCutoverConcierge: migrationModule.getCutoverConcierge,
      ...
      exportCutoverSignoffEvidence: migrationModule.exportCutoverSignoffEvidence,
      ...
      updateCutoverSourceExtractChecklistItem: migrationModule.updateCutoverSourceExtractChecklistItem,
      recordCutoverRehearsal: migrationModule.recordCutoverRehearsal,
      generateCutoverAutomatedVarianceReport: migrationModule.generateCutoverAutomatedVarianceReport,
      recordCutoverRollbackDrill: migrationModule.recordCutoverRollbackDrill,
  ...
  function snapshot() {
    return clone({
      ...
      requests: [...state.requests.values()],
        ...
        replayOperations: [...state.replayOperations.values()],
        breakGlassSessions: [...state.breakGlassSessions.values()],
        managedSecrets: [...state.managedSecrets.values()],
        secretRotationRecords: [...state.secretRotationRecords.values()],
        certificateChains: [...state.certificateChains.values()],
        callbackSecrets: [...state.callbackSecrets.values()],
        ...
        rollbackCheckpoints: [...state.rollbackCheckpoints.values()],
        restoreDrills: [...state.restoreDrills.values()],
        replayDrills: [...state.replayDrills.values()],
        ...
        mappingSets: [...state.mappingSets.values()],
          ...
          parallelRunResults: [...state.parallelRunResults.values()],
