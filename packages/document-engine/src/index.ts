...
export interface OcrRun {
  ...
  readonly providerCallbackMode: "none" | "manual_provider_callback";
  readonly pageCount: number;
  readonly maxSyncPages: number | null;
  readonly maxBatchPages: number | null;
  readonly processorType: string | null;
