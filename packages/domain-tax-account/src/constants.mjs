...
export const TAX_ACCOUNT_DIFFERENCE_CASE_STATUSES = Object.freeze(["open", "reviewed", "resolved", "waived"]);
...
export const CREDIT_EVENT_TYPES = new Set(["PAYMENT", "REFUND", "INTEREST_INCOME", "MANUAL_ADJUSTMENT"]);
