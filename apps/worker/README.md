...
- Executes typed handlers for shared runtime lanes such as OCR, submission transport, submission receipt collection, notification expiry/digests, saved-view compatibility scans and search reindex requests.
