...
const EXPLICIT_ROUTE_OVERRIDES = new Map([
  ...
  ["POST /v1/projects/vertical-pack-governance", override("projects", "project_vertical_pack_governance_publish", "strong_mfa", "company", "project_vertical_pack_governance_decision", "project_vertical_pack_governance_decision", "company.manage", false)],
  ["POST /v1/projects/:projectId/vertical-pack-links", override("projects", "project_vertical_pack_link_create", "strong_mfa", "project", "project", "project_vertical_pack_link", "company.manage", true)],
  ...
  ["POST /v1/projects/:projectId/profitability-mission-control-snapshots", override("projects", "project_profitability_mission_control_materialize", "strong_mfa", "project", "project", "project_profitability_mission_control_snapshot", "company.manage", true)],
  ...
  ["POST /v1/field/work-orders/:workOrderId/finance-handoffs", override("field", "field_work_order_finance_handoff_create", "strong_mfa", "project", "field_work_order", "field_work_order_finance_handoff", "company.manage", true)],
