...
async function handleRequest({ req, res, platform, flags, edgePolicy, edgeState }) {
      ...
      path === "/"
        ? {
            ...
            routes: filterAdvertisedRoutesForRuntime({
              ...
              "/v1/notifications/digests",
              "/v1/notifications/digests/build",
              "/v1/notifications/digests/:notificationDigestId",
              ...
              "/v1/time/balances",
              "/v1/balances/types",
              "/v1/balances/vacation-profiles",
              "/v1/balances/vacation-profiles/:vacationBalanceProfileId",
              ...
              "/v1/balances/vacation-balances",
              "/v1/balances/carry-forwards",
              "/v1/balances/vacation-year-closes",
  ...
  "/v1/backoffice/agreement-intake/cases/:agreementIntakeCaseId/review",
              ...
              "/v1/ops/secrets/:managedSecretId/revoke",
              "/v1/ops/secret-rotations",
              "/v1/ops/certificate-chains",
              "/v1/ops/certificate-chains/:certificateChainId/revoke",
              "/v1/ops/callback-secrets",
              "/v1/ops/callback-secrets/:callbackSecretId/revoke",
  ...
  if (req.method === "POST" && path === "/v1/projects/quote-handoffs") {
    const body = await readJsonBody(req);
    const companyId = requireText(body.companyId, "company_id_required", "Company id is required.");
    const principal = authorizeCompanyAccess({
      platform,
    ...
    writeJson(
      res,
      201,
      platform.convertQuoteToProject({
        companyId,
        ...
        endsOn: body.endsOn ?? null,
        billingModelCode: body.billingModelCode ?? "fixed_price",
        revenueRecognitionModelCode: body.revenueRecognitionModelCode ?? "over_time",
        workModelCode: body.workModelCode ?? "milestone_only",
        billingPlanFrequencyCode: body.billingPlanFrequencyCode ?? "one_off",
        billingPlanTriggerCode: body.billingPlanTriggerCode ?? "quote_acceptance",
        externalSystemCode: body.externalSystemCode ?? "internal_ar",
        externalOpportunityId: body.externalOpportunityId ?? null,
        externalOpportunityRef: body.externalOpportunityRef ?? null,
        actorId: principal.userId,
        correlationId: body.correlationId || createCorrelationId()
      })
    );
  ...
  const projectOpportunityLinksMatch = matchPath(path, "/v1/projects/:projectId/opportunity-links");
  if (projectOpportunityLinksMatch && req.method === "GET") {
    const companyId = requireText(
      url.searchParams.get("companyId"),
      "company_id_required",
      "companyId query parameter is required."
    ...
    const principal = authorizeCompanyAccess({
      ...
      companyId,
      permissionCode: "company.read",
      objectType: "project_opportunity_link",
      scopeCode: "project"
    });
    assertProjectWorkspaceReadAccess({ principal });
    writeJson(res, 200, {
      items: platform.listProjectOpportunityLinks({
        companyId,
        projectId: projectOpportunityLinksMatch.projectId
      })
    });
    return;
  }

  if (projectOpportunityLinksMatch && req.method === "POST") {
    const body = await readJsonBody(req);
    const companyId = requireText(body.companyId, "company_id_required", "Company id is required.");
    const principal = authorizeCompanyAccess({
      platform,
    ...
    writeJson(
      res,
      201,
      platform.createProjectOpportunityLink({
        companyId,
        projectId: projectOpportunityLinksMatch.projectId,
        projectOpportunityLinkId: body.projectOpportunityLinkId ?? null,
        externalSystemCode: body.externalSystemCode,
        externalOpportunityId: body.externalOpportunityId,
        externalOpportunityRef: body.externalOpportunityRef ?? null,
        stageCode: body.stageCode ?? "accepted",
        customerId: body.customerId ?? null,
        actorId: principal.userId,
        correlationId: body.correlationId || createCorrelationId()
      })
  ...
  const projectQuoteLinksMatch = matchPath(path, "/v1/projects/:projectId/quote-links");
  if (projectQuoteLinksMatch && req.method === "GET") {
    const companyId = requireText(
      url.searchParams.get("companyId"),
      "company_id_required",
      "companyId query parameter is required."
    ...
    const principal = authorizeCompanyAccess({
      ...
      companyId,
      permissionCode: "company.read",
      objectType: "project_quote_link",
      scopeCode: "project"
    });
    assertProjectWorkspaceReadAccess({ principal });
    writeJson(res, 200, {
      items: platform.listProjectQuoteLinks({
        companyId,
        projectId: projectQuoteLinksMatch.projectId
      })
    });
    return;
  }

  if (projectQuoteLinksMatch && req.method === "POST") {
    const body = await readJsonBody(req);
    const companyId = requireText(body.companyId, "company_id_required", "Company id is required.");
    const principal = authorizeCompanyAccess({
      platform,
    ...
    writeJson(
      res,
      201,
      platform.createProjectQuoteLink({
        companyId,
        projectId: projectQuoteLinksMatch.projectId,
        ...
        sourceQuoteVersionId: body.sourceQuoteVersionId ?? null,
        externalSystemCode: body.externalSystemCode ?? "internal_ar",
        externalQuoteRef: body.externalQuoteRef ?? null,
        acceptedOn: body.acceptedOn ?? null,
        customerId: body.customerId ?? null,
        actorId: principal.userId,
        correlationId: body.correlationId || createCorrelationId()
      })
  ...
  if (projectEngagementsMatch && req.method === "GET") {
    ...
    const principal = authorizeCompanyAccess({
      ...
      companyId,
      permissionCode: "company.read",
      objectType: "project_engagement",
      scopeCode: "project"
    });
    assertProjectWorkspaceReadAccess({ principal });
    writeJson(res, 200, {
      items: platform.listProjectEngagements({
        companyId,
        projectId: projectEngagementsMatch.projectId,
        status: url.searchParams.get("status") || null
      })
    });
    return;
  ...
  if (projectEngagementsMatch && req.method === "POST") {
    const body = await readJsonBody(req);
    const companyId = requireText(body.companyId, "company_id_required", "Company id is required.");
    const principal = authorizeCompanyAccess({
      platform,
    ...
    writeJson(
      res,
      201,
      platform.createProjectEngagement({
        companyId,
        projectId: projectEngagementsMatch.projectId,
  ...
  const projectWorkModelsMatch = matchPath(path, "/v1/projects/:projectId/work-models");
  if (projectWorkModelsMatch && req.method === "GET") {
    const companyId = requireText(
      url.searchParams.get("companyId"),
      "company_id_required",
      "companyId query parameter is required."
    ...
    const principal = authorizeCompanyAccess({
      ...
      companyId,
      permissionCode: "company.read",
      objectType: "project_work_model",
      scopeCode: "project"
    });
    assertProjectWorkspaceReadAccess({ principal });
    writeJson(res, 200, {
      items: platform.listProjectWorkModels({
        companyId,
        projectId: projectWorkModelsMatch.projectId
      })
    });
    return;
  }

  if (projectWorkModelsMatch && req.method === "POST") {
    const body = await readJsonBody(req);
    const companyId = requireText(body.companyId, "company_id_required", "Company id is required.");
    const principal = authorizeCompanyAccess({
      platform,
    ...
    writeJson(
      res,
      201,
      platform.createProjectWorkModel({
        companyId,
        projectId: projectWorkModelsMatch.projectId,
        projectWorkModelId: body.projectWorkModelId ?? null,
        projectEngagementId: body.projectEngagementId ?? null,
        modelCode: body.modelCode,
        title: body.title,
        operationalPackCode: body.operationalPackCode ?? "general_core",
        requiresWorkOrders: body.requiresWorkOrders === true,
        requiresMilestones: body.requiresMilestones === true,
        requiresAttendance: body.requiresAttendance === true,
        requiresId06: body.requiresId06 === true,
        actorId: principal.userId,
        correlationId: body.correlationId || createCorrelationId()
      })
    );
  ...
  const projectWorkPackagesMatch = matchPath(path, "/v1/projects/:projectId/work-packages");
  if (projectWorkPackagesMatch && req.method === "GET") {
    const companyId = requireText(
      url.searchParams.get("companyId"),
      "company_id_required",
      "companyId query parameter is required."
    ...
    const principal = authorizeCompanyAccess({
      ...
      companyId,
      permissionCode: "company.read",
      objectType: "project_work_package",
      scopeCode: "project"
    });
    assertProjectWorkspaceReadAccess({ principal });
    writeJson(res, 200, {
      items: platform.listProjectWorkPackages({
        companyId,
        projectId: projectWorkPackagesMatch.projectId,
        status: url.searchParams.get("status") || null
      })
    });
    return;
  ...
  if (projectWorkPackagesMatch && req.method === "POST") {
    const body = await readJsonBody(req);
    const companyId = requireText(body.companyId, "company_id_required", "Company id is required.");
    const principal = authorizeCompanyAccess({
      platform,
    ...
    writeJson(
      res,
      201,
      platform.createProjectWorkPackage({
        companyId,
        projectId: projectWorkPackagesMatch.projectId,
        projectWorkPackageId: body.projectWorkPackageId ?? null,
        projectEngagementId: body.projectEngagementId ?? null,
        projectWorkModelId: body.projectWorkModelId ?? null,
        workPackageCode: body.workPackageCode ?? null,
        title: body.title,
        description: body.description ?? null,
        startsOn: body.startsOn ?? null,
        endsOn: body.endsOn ?? null,
  ...
  const projectDeliveryMilestonesMatch = matchPath(path, "/v1/projects/:projectId/delivery-milestones");
  if (projectDeliveryMilestonesMatch && req.method === "GET") {
    const companyId = requireText(
      url.searchParams.get("companyId"),
      "company_id_required",
      "companyId query parameter is required."
    ...
    const principal = authorizeCompanyAccess({
      ...
      companyId,
      permissionCode: "company.read",
      objectType: "project_delivery_milestone",
      scopeCode: "project"
    });
    assertProjectWorkspaceReadAccess({ principal });
    writeJson(res, 200, {
      items: platform.listProjectDeliveryMilestones({
        companyId,
        projectId: projectDeliveryMilestonesMatch.projectId,
        status: url.searchParams.get("status") || null
      })
    });
    return;
  ...
  if (projectDeliveryMilestonesMatch && req.method === "POST") {
    const body = await readJsonBody(req);
    const companyId = requireText(body.companyId, "company_id_required", "Company id is required.");
    const principal = authorizeCompanyAccess({
      platform,
    ...
    writeJson(
      res,
      201,
      platform.createProjectDeliveryMilestone({
        companyId,
        projectId: projectDeliveryMilestonesMatch.projectId,
        projectDeliveryMilestoneId: body.projectDeliveryMilestoneId ?? null,
        projectWorkPackageId: body.projectWorkPackageId ?? null,
        title: body.title,
        targetDate: body.targetDate,
        plannedRevenueAmount: body.plannedRevenueAmount ?? 0,
  ...
  const projectWorkLogsMatch = matchPath(path, "/v1/projects/:projectId/work-logs");
  if (projectWorkLogsMatch && req.method === "GET") {
    const companyId = requireText(
      url.searchParams.get("companyId"),
      "company_id_required",
      "companyId query parameter is required."
    ...
    const principal = authorizeCompanyAccess({
      ...
      companyId,
      permissionCode: "company.read",
      objectType: "project_work_log",
      scopeCode: "project"
    });
    assertProjectWorkspaceReadAccess({ principal });
    writeJson(res, 200, {
      items: platform.listProjectWorkLogs({
        companyId,
        projectId: projectWorkLogsMatch.projectId,
        workDate: url.searchParams.get("workDate") || null
      })
    });
    return;
  ...
  if (projectWorkLogsMatch && req.method === "POST") {
    const body = await readJsonBody(req);
    const companyId = requireText(body.companyId, "company_id_required", "Company id is required.");
    const principal = authorizeCompanyAccess({
      platform,
    ...
    writeJson(
      res,
      201,
      platform.recordProjectWorkLog({
        companyId,
        projectId: projectWorkLogsMatch.projectId,
        projectWorkLogId: body.projectWorkLogId ?? null,
        projectWorkPackageId: body.projectWorkPackageId ?? null,
        projectDeliveryMilestoneId: body.projectDeliveryMilestoneId ?? null,
        employmentId: body.employmentId ?? null,
        workDate: body.workDate,
        ...
        description: body.description,
        billableFlag: body.billableFlag !== false,
  ...
  const projectRevenuePlansMatch = matchPath(path, "/v1/projects/:projectId/revenue-plans");
  if (projectRevenuePlansMatch && req.method === "GET") {
    const companyId = requireText(
      url.searchParams.get("companyId"),
      "company_id_required",
      "companyId query parameter is required."
    ...
    const principal = authorizeCompanyAccess({
      ...
      companyId,
      permissionCode: "company.read",
      objectType: "project_revenue_plan",
      scopeCode: "project"
    });
    assertProjectWorkspaceReadAccess({ principal });
    writeJson(res, 200, {
      items: platform.listProjectRevenuePlans({
        companyId,
        projectId: projectRevenuePlansMatch.projectId,
        status: url.searchParams.get("status") || null
      })
    });
    return;
  ...
  if (projectRevenuePlansMatch && req.method === "POST") {
    const body = await readJsonBody(req);
    const companyId = requireText(body.companyId, "company_id_required", "Company id is required.");
    const principal = authorizeCompanyAccess({
      platform,
    ...
    writeJson(
      res,
      201,
      platform.createProjectRevenuePlan({
        companyId,
        projectId: projectRevenuePlansMatch.projectId,
        projectRevenuePlanId: body.projectRevenuePlanId ?? null,
  ...
  const projectRevenuePlanApproveMatch = matchPath(path, "/v1/projects/:projectId/revenue-plans/:projectRevenuePlanId/approve");
  if (projectRevenuePlanApproveMatch && req.method === "POST") {
    const body = await readJsonBody(req);
    const companyId = requireText(body.companyId, "company_id_required", "Company id is required.");
    const principal = authorizeCompanyAccess({
      platform,
    ...
    writeJson(
      ...
      platform.approveProjectRevenuePlan({
        companyId,
        projectId: projectRevenuePlanApproveMatch.projectId,
        projectRevenuePlanId: projectRevenuePlanApproveMatch.projectRevenuePlanId,
        actorId: principal.userId,
        correlationId: body.correlationId || createCorrelationId()
      })
    );
  ...
  if (projectBillingPlansMatch && req.method === "GET") {
    ...
    const principal = authorizeCompanyAccess({
      ...
      companyId,
      permissionCode: "company.read",
      objectType: "project_billing_plan",
      scopeCode: "project"
    });
    assertProjectWorkspaceReadAccess({ principal });
    writeJson(res, 200, {
      items: platform.listProjectBillingPlans({
        companyId,
        projectId: projectBillingPlansMatch.projectId,
        status: url.searchParams.get("status") || null
      })
    });
    return;
  ...
  if (projectBillingPlansMatch && req.method === "POST") {
    const body = await readJsonBody(req);
    const companyId = requireText(body.companyId, "company_id_required", "Company id is required.");
    const principal = authorizeCompanyAccess({
      platform,
    ...
    writeJson(
      ...
      platform.createProjectBillingPlan({
        companyId,
        projectId: projectBillingPlansMatch.projectId,
        projectBillingPlanId: body.projectBillingPlanId ?? null,
        projectQuoteLinkId: body.projectQuoteLinkId ?? null,
        frequencyCode: body.frequencyCode ?? "one_off",
        triggerCode: body.triggerCode ?? "manual",
        startsOn: body.startsOn ?? null,
        endsOn: body.endsOn ?? null,
        status: body.status ?? "draft",
        lines: body.lines || [],
  ...
  const projectStatusUpdatesMatch = matchPath(path, "/v1/projects/:projectId/status-updates");
  if (projectStatusUpdatesMatch && req.method === "GET") {
    const companyId = requireText(
      url.searchParams.get("companyId"),
      "company_id_required",
      "companyId query parameter is required."
    ...
    const principal = authorizeCompanyAccess({
      ...
      companyId,
      permissionCode: "company.read",
      objectType: "project_status_update",
      scopeCode: "project"
    });
    assertProjectWorkspaceReadAccess({ principal });
    writeJson(res, 200, {
      items: platform.listProjectStatusUpdates({
        companyId,
        projectId: projectStatusUpdatesMatch.projectId
      })
    });
    return;
  }

  if (projectStatusUpdatesMatch && req.method === "POST") {
    const body = await readJsonBody(req);
    const companyId = requireText(body.companyId, "company_id_required", "Company id is required.");
    const principal = authorizeCompanyAccess({
      platform,
    ...
    writeJson(
      ...
      platform.createProjectStatusUpdate({
        companyId,
        projectId: projectStatusUpdatesMatch.projectId,
        projectStatusUpdateId: body.projectStatusUpdateId ?? null,
        statusDate: body.statusDate ?? null,
        healthCode: body.healthCode,
        progressPercent: body.progressPercent ?? 0,
        blockerCodes: Array.isArray(body.blockerCodes) ? body.blockerCodes : [],
        atRiskReason: body.atRiskReason ?? null,
        note: body.note ?? null,
        sourceSystemCode: body.sourceSystemCode ?? "project_core",
        externalStatusRef: body.externalStatusRef ?? null,
        actorId: principal.userId,
        correlationId: body.correlationId || createCorrelationId()
      })
    );
  ...
  if (projectProfitabilitySnapshotsMatch && req.method === "GET") {
    ...
    const principal = authorizeCompanyAccess({
      ...
      companyId,
      permissionCode: "company.read",
      objectType: "project_profitability_snapshot",
      scopeCode: "project"
    });
    assertProjectWorkspaceReadAccess({ principal });
    writeJson(res, 200, {
      items: platform.listProjectProfitabilitySnapshots({
        companyId,
  ...
  if (projectProfitabilitySnapshotsMatch && req.method === "POST") {
    const body = await readJsonBody(req);
    const companyId = requireText(body.companyId, "company_id_required", "Company id is required.");
    const principal = authorizeCompanyAccess({
      platform,
